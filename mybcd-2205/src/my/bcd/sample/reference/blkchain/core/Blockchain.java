 ...
 */
package my.bcd.sample.reference.blkchain.core;
...
import my.bcd.sample.reference.blkchain.demo.BlockchainTest;
...
public class Blockchain {
    ...
    private static final String CHAIN_OBJFILE = "src/my/bcd/sample/master/chainobj.dat";
    ...
    public static void distribute( String temp ){
        try {
            Files.write(Paths.get("src/my/bcd/sample/bc.txt"), temp.getBytes(), StandardOpenOption.CREATE);
