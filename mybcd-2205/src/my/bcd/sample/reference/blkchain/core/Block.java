...
import my.bcd.sample.reference.blkchain.shautils.HashingUtils;
...
public class Block implements Serializable {
    ...
    public Block(List<List<String>> data, String previoushash) {
        ...
        this.currentHash = this.blockHashCode(
                Block.genByteArr(this.data), this.previoushash, this.timestamp);
    }
